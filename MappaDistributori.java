...
/*while (esso.getDeposito() > 0){
        ...
        // quando il codice arriva qua, la panda ha finito la benzina, deve quindi rifornirsi, e conviene anche che faccia manutenzione ruote
      System.out.println("Panda ha finito la benzina");
      panda.controlloRuote();
      panda.stampaInfo();
      esso.manutenzioneRuote(panda.ruote);
      esso.vendi(100, panda);
      panda.stampaInfo();
      System.out.println(esso.getDeposito());
      break;
      } */
